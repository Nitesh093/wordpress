...
register_block_pattern(
  ...
  array(
    ...
    'description' => __('A fullwidth hero with an image a title, description and call to action.', 'simplexp'),
...
register_block_pattern(
  ...
  array(
    ...
    'description' => __('Last CTA block with title description and CTA button', 'simplexp'),
...
register_block_pattern(
  ...
  array(
    ...
    <!-- wp:columns -->
    <div class="wp-block-columns"><!-- wp:column -->
    <div class="wp-block-column"><!-- wp:heading {"level":3,"style":{"spacing":{"margin":{"top":"var:preset|spacing|40"}}}} -->
    <h3 class="wp-block-heading" style="margin-top:var(--wp--preset--spacing--40)">What payment methods are accepted?</h3>
    <!-- /wp:heading -->
    ...
    <h3 class="wp-block-heading" style="margin-top:var(--wp--preset--spacing--40)">What are the delivery times?</h3>
    <!-- /wp:heading -->
    ...
    <!-- wp:heading {"level":3,"style":{"spacing":{"margin":{"top":"var:preset|spacing|40"}}}} -->
    <h3 class="wp-block-heading" style="margin-top:var(--wp--preset--spacing--40)">What are the opening hours?</h3>
    <!-- /wp:heading -->
    ...
    <!-- wp:heading {"level":3,"style":{"spacing":{"margin":{"top":"var:preset|spacing|40"}}}} -->
    <h3 class="wp-block-heading" style="margin-top:var(--wp--preset--spacing--40)">How can I reset my password?</h3>
    <!-- /wp:heading -->
